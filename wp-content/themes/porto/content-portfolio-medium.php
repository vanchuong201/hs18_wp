...
<article <?php post_class($post_class); ?>>
    ...
    <div class="row<?php echo ($porto_layout === 'widewidth' ? ' m-t-lg m-r m-l' : '') ?>">
        <?php
        // Portfolio Slideshow
        ...
        <?php endif; ?>
            ...
            <?php if (get_the_content()) : ?><h5 class="inline-block portfolio-desc"><?php _e('Project Description', 'porto') ?></h5><?php endif; ?>
