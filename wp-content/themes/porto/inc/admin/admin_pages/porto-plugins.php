        ...
        <div class="porto-install-plugins">
            <div class="feature-section theme-browser rendered">
                <?php foreach ( $plugins as $plugin ) : ?>
                    ...
                    if ( isset( $plugin['visibility'] ) && 'hidden' === $plugin['visibility'] ) {
                        $class .= ' hidden';
                    }
                    ?>

                    <?php if ( 'regenerate-thumbnails' === $plugin['slug'] ) : ?>
                        <div style="clear: both; padding: 0 15px; text-align: center; margin-bottom: 20px;">
                            <a href="#" class="button button-primary button-load-plugins"><?php esc_html_e( 'Load more plugins fully compatible with Porto', 'porto' ); ?></a>
                        </div>
                    <?php endif; ?>
