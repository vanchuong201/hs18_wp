        ...
        <table class="widefat" cellspacing="0">
            ...
            <tr>
                ...
                <td><?php
                    ...
                    if ( $memory < 128000000 ) {
                        echo '<mark class="yes">' . sprintf( __( '%s - We recommend setting memory to at least <strong>128MB</strong>. <br /> You can increase memory limit in <strong>wp-config.php</strong> file. To learn how, see: <a href="%s" target="_blank">Increasing memory allocated to PHP.</a>', 'porto' ), size_format( $memory ), 'http://codex.wordpress.org/Editing_wp-config.php#Increasing_memory_allocated_to_PHP' ) . '</mark>';
                    } else {
                    ...
                    <td>
                        <?php
                            ...
                            if ( $max_input_vars < 2000 ) {
                                echo '<mark class="error">' . __( 'Minimum 2000 is required', 'porto' ) . '</mark>';
                            } else {
