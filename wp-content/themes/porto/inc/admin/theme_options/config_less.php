...
@panel_border_color: <?php echo $b['panel-border-color'] ?>;
@panel_link_hbgcolor: <?php echo $b['panel-link-hbgcolor'] ?>;
...
@main_menu_level1_link_color_sticky: <?php echo $b['mainmenu-toplevel-link-color-sticky']['regular'] ?>;

@main_menu_level1_hover_color_sticky: <?php echo $b['mainmenu-toplevel-link-color-sticky']['hover'] ?>;
...
@main_menu_custom_link_hcolor: <?php echo $b['menu-custom-link']['hover'] ?>;@sticky_menu_bg_color: <?php if($b['mainmenu-wrap-bg-color-sticky'] && $b['mainmenu-wrap-bg-color-sticky'] != 'transparent') echo $b['mainmenu-wrap-bg-color-sticky']; else if ($b['mainmenu-bg-color'] && $b['mainmenu-bg-color'] != 'transparent') echo $b['mainmenu-bg-color']; else if ($b['mainmenu-wrap-bg-color'] && $b['mainmenu-wrap-bg-color'] != 'transparent') echo $b['mainmenu-wrap-bg-color']; else echo $b['sticky-header-bg']['background-color'] ?>;
...
@footer_label_color: <?php echo $b['footer-label-color'] ?>;@footer_text_color: <?php echo $b['footer-text-color'] ?>;
...
@border-color-wishlist: <?php echo $b['wishlist-border-color'] ?>;
@color-wishlist-inverse: <?php echo $b['wishlist-color-inverse'] ?>;
@color-quickview: <?php echo $b['quickview-color'] ?>;
@border-color-quickview: <?php echo $b['quickview-border-color'] ?>;
...
@add_to_cart_font_family: <?php echo $b['add-to-cart-font']['font-family'] ?>;