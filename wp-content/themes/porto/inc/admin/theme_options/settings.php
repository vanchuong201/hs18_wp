        ...
        public function setSections() {
            ...
            $this->sections[] = array(
                ...
                'fields' => array(
                    array(
                        'id'        => '1',
                        'type'      => 'info',
                        'title' => __('After save the changes, will regenerate the css files (skin_' . get_current_blog_id() . '.css, skin_rtl_' . get_current_blog_id() . '.css) in ', 'porto') . '<strong>' . porto_dir . '/css</strong>.',
                        'style' => 'info'
                    ),
                    array(
            ...
            $this->sections[] = array(
                ...
                'fields' => array(
                    ...
                    array(
                        ...
                        'default' => array('padding-top' => 5, 'padding-bottom' => 5, 'padding-left' => 5, 'padding-right' => 5)
                    ),
                    array(
            ...
            $this->sections[] = array(
                ...
                'fields' => array(
                    ...
                    array(
                        'id'=>'wishlist-border-color',
                        'type' => 'color',
                        'title' => __('Wishlist Border Color', 'porto'),
                        'default' => '#d8d8d6',
                        'validate' => 'color',
                    ),
                    array(
                    ...
                    array(
                        'id'=>'quickview-border-color',
                        'type' => 'color',
                        'title' => __('Quick View Border Color', 'porto'),
                        'default' => '#d8d8d6',
                        'validate' => 'color',
                    ),
                    array(
                ...
                'fields' => array(
                    ...
                    array(
                        ...
                        'options' => array(
                            ...
                            'minicart-arrow' => array('alt' => __('Minicart Type 4', 'porto'), 'img' => porto_options_uri.'/minicarts/minicart_04.png'),
                            'minicart-arrow-alt' => array('alt' => __('Minicart Type 5', 'porto'), 'img' => porto_options_uri.'/minicarts/minicart_05.png'),
                        ),
                    ...
                    array(
                        'id' => "minicart-popup-style",
                        'type' => 'button_set',
                        'title' => __('Minicart Popup', 'porto'),
                        'required' => array('show-minicart','equals',true),
                        'options' => array(
                            '' => __('Style 1', 'porto'),
                            '2' => __('Style 2', 'porto'),
            ...
            $this->sections[] = array(
                ...
                'fields' => array(
                    ...
                    array(
                        ...
                        'required' => array('show-searchform','equals',true),
                        'options' => array('all' => __('All', 'porto'), 'post' => __('Post', 'porto'), 'product' => __('Product', 'porto'), 'portfolio' => __('Portfolio', 'porto'), 'event' => __('Event', 'porto')),
                        'default' => 'all'
                    ),
                    array(
                        'id'=>'search-cats',
                ...
                'fields' => array(
                    ...
                    array(
                        ...
                        'options' => array(
                            ...
                            "medium-alt" => array('alt' => __('Medium Alternate', 'porto'), 'img' => porto_options_uri.'/images/post_archive_style_7.jpg')
                        ),
                        'default' => 'full'
                    ),
                    array(
                ...
                'fields' => array(
                    ...
                    array(
                        ...
                        'options' => array(
                            ...
                            "full-alt" => array('alt' => __('Full Alt', 'porto'), 'img' => porto_options_uri.'/images/post_single_style_5.jpg'),
                        ),
                        'default' => 'full'
                    ),
                    array(
    ...
    $this->sections[] = array(
        ...
        'fields' => array(
            ...
            $this->sections[] = array(
                ...
                $this->sections[] = array(
                    ...
                    'fields' => array(
                        ...
                        array(
                            ...
                            'options' => array(
                                "outimage" => array('alt' => __('Out of Image 1', 'porto'), 'img' => porto_options_uri.'/images/product_addlinks_style.jpg'),
                                "outimage2" => array('alt' => __('Out of Image 2', 'porto'), 'img' => porto_options_uri.'/images/product_addlinks_style_1.jpg'),
                                ...
                                "outimage_q_onimage" => array('alt' => __('Out of Image, Quick View On Image', 'porto'), 'img' => porto_options_uri.'/images/product_addlinks_style_4.jpg'),
                                "outimage_q_onimage_alt" => array('alt' => __('Out of Image, Quick View On Image Alt', 'porto'), 'img' => porto_options_uri.'/images/product_addlinks_style_5.jpg'),
                            ),
                            'default' => 'outimage'
                        ),
                        array(
                ...
                $this->sections[] = array(
                    ...
                    'fields' => array(
                        ...
                        array(                            
                            'id'=>'product-tabs-style',                            
                            'type' => 'button_set',                            
                            'title' => __('Tabs Style', 'porto'),                            
                            'required' => array('product-tabs','equals',array( 'default','vertical','accordion' )),                            
                            'options' => array('' => __('Style 1', 'porto'), '2' => __('Style 2', 'porto')),                            
                        ),
                        array(
                            'id'=>'product-tabs-pos',
                            'type' => 'button_set',
                        ...
                        array(
                            ...
                            'type' => 'button_set',
                            'default' => 'button',
                            'options' => array( 'button' => __( 'Button', 'porto' ), 'select' => __( 'Select Box', 'porto' ) )
                        ),
                        array(
            ...
            $this->sections[] = array(
                'icon' => 'el-icon-broom',
                'icon_class' => 'icon',
                'title' => __('Speed Optimize', 'porto'),
                'fields' => array(
                    array(
                        'id'=>'speed-optimize-bootstrap',
                        'type' => 'switch',
                        'title' => __('Optimize Bootstrap', 'porto'),
                        'desc' => __( 'By using this option, you can use bootstrap features only what you used for. This will reduce around 150KB of page size.', 'porto' ),
                        'default' => false,
                        'on' => __('Yes', 'porto'),
                        'off' => __('No', 'porto'),
                        'compiler' => true
                    ...
                    array(
                        'id'=>'speed-optimize-js-composer',
                        'type' => 'switch',
                        'title' => __('Optimize Visual Composer', 'porto'),
                        'desc' => __( 'By using this option, you can use visual composer features only what you used for. This will reduce around 200KB of page size.', 'porto' ),
                        'default' => false,
                        'on' => __('Yes', 'porto'),
                        'off' => __('No', 'porto'),
                    ),
                    array(
                        'id'=>'speed-optimize-fontawesome',
                        'type' => 'switch',
                        'title' => __('Optimize FontAwesome icons', 'porto'),
                        'desc' => __( 'By using this option, you can use fontawesome icons only what you used for. This will reduce around 40KB of page size.', 'porto' ),
                        'default' => false,
                        'on' => __('Yes', 'porto'),
                        'off' => __('No', 'porto'),
                    ),
                    array(
                        'id'=>'speed-optimize-revslider',
                        'type' => 'switch',
                        'title' => __('Optimize Revolution Slider', 'porto'),
                        'desc' => __( 'By using this option, you can use revoltion slider features only what you used for. This will reduce around 40KB of page size.', 'porto' ),
                        'default' => false,
                        'on' => __('Yes', 'porto'),
                        'off' => __('No', 'porto'),
                    ),
                    array(
                        'id' => 'speed-optimize-revslider-page',
                        'type' => 'select',
                        'data' => 'page',
                        'multi' => true,
                        'required' => array( 'speed-optimize-revslider', 'equals', true ),
                        'title' => __('Revolution Slider Page', 'porto'),
                        'desc' => __( 'Please select the pages which have revolution sliders. CSS/JS files of revolution slider will be loaded for only these pages.', 'porto' ),
                    ),
                )
            );
        }
