    ...
    if ( $tag =='vc_column' || $tag =='vc_column_inner' ) {
        if ( !( function_exists( 'vc_is_inline' ) && vc_is_inline() ) ) {
            if ( preg_match( '/vc_col-(\w{2})-(\d{1,2})/', $class_string ) ) {
                ...
                $class_string = str_replace( array( 'vc_col-lg-', 'vc_col-md-', 'vc_col-sm-', 'vc_col-xs-' ), array( 'col-xl-', 'col-lg-', 'col-md-', 'col-' ), $class_string );
            }
            if ( preg_match( '/vc_hidden-(\w{2})/', $class_string ) ) {
                ...
                for ( $i = 0; $i <= 3; $i++ ) {
                    ...
                    if ( strpos( $class_string, $screen.'-block' ) !== false &&
                         strpos( $class_string, $screen.'-none' ) !== false ) {
                ...
                for ( $i = 3; $i >= 1; $i-- ) {
                    ...
                    if ( strpos( $class_string, $screen.'-none' ) !== false &&
                         strpos( $class_string, $screen_bigger.'-none' ) !== false ) {
