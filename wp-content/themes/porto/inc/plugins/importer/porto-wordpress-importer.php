        ...
        function process_posts($index = 0) {
            ...
            //foreach ( $this->posts as $post ) {
                ...
                if ( 'attachment' == $post['post_type'] && $post_exists && get_post_type( $post_exists ) == $post['post_type'] ) {
                    $override_contents = (isset($_POST['override_contents']) && $_POST['override_contents'] == 'true') ? true : false;
...
//                    echo '<br />';
                    ...
                    if ( 'page' == $post['post_type'] || 'block' == $post['post_type'] || 'member' == $post['post_type'] || 'portfolio' == $post['post_type'] || 'event' == $post['post_type'] ) {
                        ...
                        $postdata = array(
                            'ID' => $post_id, 'post_author' => $author, 'post_date' => $post['post_date'],
