...
$page_header_type = isset($porto_settings['breadcrumbs-type']) ? $porto_settings['breadcrumbs-type'] : '3';
...
<div class="container<?php if ($hide_title) : ?> hide-title<?php endif; ?>">
    <div class="row">
        <div class="col-lg-12">
            <div class="text-center <?php if ($hide_title) : ?> d-none<?php endif; ?>">
            ...
            <?php if ($breadcrumbs) : ?>
                <div class="breadcrumbs-wrap text-center<?php if ($sub_title) : ?> breadcrumbs-with-subtitle<?php endif; ?>">
