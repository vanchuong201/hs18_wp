...
$page_header_type = isset($porto_settings['breadcrumbs-type']) ? $porto_settings['breadcrumbs-type'] : '5';
...
<div class="container<?php if ($hide_title) : ?> hide-title<?php endif; ?>">
    <div class="row">
        <div class="col-lg-12 clearfix">
            <div class="pt-right<?php if ($hide_title) : ?> d-none<?php endif; ?>">
            ...
            <?php if ($breadcrumbs) : ?>
                <div class="breadcrumbs-wrap pt-left<?php if ($sub_title) : ?> breadcrumbs-with-subtitle<?php endif; ?>">
