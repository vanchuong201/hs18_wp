...
<?php elseif ( 'side' === $header_type ) : ?>
    ...
    @media (min-width: 992px) {
        ...
        .header-wrapper.header-side-nav #header .searchform button { padding: 0 10px 0 8px; }
...
.single-product .variations:after { left: <?php echo $b['grid-gutter-width'] / 2; ?>px; width: calc(100% - <?php echo $b['grid-gutter-width']; ?>px); }
...
<?php if ( class_exists( 'Woocommerce' ) ) : ?>
    ...
    .product-image,
    <?php endif; ?>
    .product-images .img-thumbnail { border: 1px solid <?php echo $dark ? $color_dark_3 : "#ddd"; ?>; }
