...
<div class="card card-default">
	...
	<div class="card-header arrow">
		<h2 class="card-title"><a class="accordion-toggle" data-toggle="collapse" href="#panel-cart-total"><?php _e( 'CART TOTALS', 'porto' ); ?></a></h2>
	</div>
	<div id="panel-cart-total" class="accordion-body collapse"><div class="card-body">
		<table class="responsive cart-total" cellspacing="0">
			...
			<tr class="order-total">
				<th><?php _e( 'Grand Total', 'porto' ); ?></th>
