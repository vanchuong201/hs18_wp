				...
				<div class="box-content">
					<form class="woocommerce-cart-form" action="<?php echo esc_url( version_compare($porto_woo_version, '2.5', '<') ? WC()->cart->get_cart_url() : wc_get_cart_url() ); ?>" method="post">
											...
											<div class="accordion">
												<div class="card card-default">
													<div class="card-header arrow">
														<h2 class="card-title"><a class="accordion-toggle" data-toggle="collapse" href="#panel-cart-discount"><?php esc_html_e( 'DISCOUNT CODE', 'porto' ); ?></a></h2>
													</div>
						...
						<div class="cart-actions">
							<a class="btn btn-default" href="<?php echo get_permalink( woocommerce_get_page_id( 'shop' ) ); ?>"><?php esc_html_e( 'Continue Shopping', 'porto' ); ?></a>
